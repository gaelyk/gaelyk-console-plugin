...
<style type="text/css">
    ...
    .ace_editor {
       font-size: ${eu.appsatori.gaelyk.console.GaelykConsolePlugin.fontSize}px;
    }
...
<body>
    ...
    <script>
        window.onload = function() {
            ...
            document.getElementById('template').style.fontSize='${eu.appsatori.gaelyk.console.GaelykConsolePlugin.fontSize}px';
        };
        </script>
</body>
</html>